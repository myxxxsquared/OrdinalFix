...
pub fn impl_semantic_symbolic_processor_inner(
    ...
    if let Some(root_inh) = root_inh {
        root_inh_quotes.extend(quote! {
            use ::fixing_rs_base::symbolic::{ContainingSingleEntity, IntoUnionEntity};
    ...
    Ok(impl_body_gen.generate(quote!(
        ...
        fn process_non_terminal_inh<'s>(
            &self,
            world: &mut ::fixing_rs_base::symbolic::SymbolicWorld,
            container_i: &'s <Self::ESI<'s> as EntityUnion<'s>>::Container,
            container_s: &'s <Self::ESS<'s> as EntityUnion<'s>>::Container,
        ...
        fn process_symbolic_terminal_gen<'s>(
            &self,
            world: &mut ::fixing_rs_base::symbolic::SymbolicWorld,
            solution: &::fixing_rs_base::symbolic::SymbolicSolution,
            symbol: ::fixing_rs_base::grammar::SymbolRef<'_>,
            gprop: &::fixing_rs_base::props::PropArray<Self::PG>,
            inh: Self::ESI<'s>,
            syn: Self::ESS<'s>,
